...
| 模式分类 | 场景与属性设定 | 规则 BFS 猎人<br>胜率 / 不败率 | 逃跑拉扯怪 (Flee)<br>胜率 / 不败率 | 高级时空 A*<br>胜率 / 不败率 | 人类玩家 (实测 50 局)<br>胜率 / 不败率 | 核心战术表现 |
|---|---|---|---|---|---|---|
| **全场景标准对局** | 241 张真实地图，白板初始属性与默认血量，涵盖破砖开荒与吃道具发育 | 53.9% / 82.8% | 71.4% / 91.4% | 78.0% / 92.0% | 80.0% / 94.0% | 兼顾长程寻路、推箱破障与伏击截杀 |
| **开阔地满配残局** | 高比例空旷道场与格斗图，满配属性（满速/满泡/满火），纯身法博弈 | 82.5% / 96.0% | 65.0% / 90.0% | 90.0% / 100.0% | 86.0% / 96.0% | 贴身并排连泡、四向合围与瞬爆绝杀 |

> 注：不败率包含获胜与超时平局（胜+平）。人类对战数据基于 50 局实战盲测：AI 取得 43 胜 5 平 2 负（胜率 86.0%，不败率 96.0%）。人类获胜的两局中，一局源于 AI 在死角窄道落泡自陷，另一局为一血极限模式下险胜；5 局平局多为双方满速拉扯互未露出致命破绽。
