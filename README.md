...
| 模式分类 | 场景与属性设定 | 规则 BFS 猎人 | 逃跑拉扯怪 (Flee) | 高级时空 A* | 人类玩家 (实测 50 局) | 核心战术表现 |
|---|---|---|---|---|---|---|
| **全场景标准对局** | 241 张真实地图均匀抽样，默认初始血量与白板属性，涵盖破砖开荒与吃道具成长 | 53.9% | 71.4% | 78.0% | ~92.0% | 兼顾长程寻路、推箱破障与伏击截杀 |
| **开阔地满配残局** | 高比例空旷道场与格斗图，满配属性（满速/满泡/满火），纯身法博弈 | 82.5% | 65.0% | 90.0% | 96.0%（48 胜 2 负） | 贴身并排连泡、四向合围与瞬爆绝杀 |

> 注：人类对战数据基于 50 局实战盲测，AI 取得 48 胜 2 负（胜率 96.0%）。人类获胜的两局中，一局源于 AI 在死角窄道落泡自陷，另一局为一血极限模式下险胜。
