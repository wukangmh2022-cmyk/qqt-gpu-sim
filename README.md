...
| 对战对手 | 对手类型与机制 | 全场景标准开荒（241 图）<br>胜 - 平 - 负（不败率） | 开阔地满配残局（纯身法）<br>胜 - 平 - 负（不败率） | 核心对抗特征 |
|---|---|:---:|:---:|---|
| **人类高玩（50 局实测）** | 真实人类深度盲测，考验临场应变与失误捕捉 | 40 胜 7 平 3 负（**94.0%**） | 43 胜 5 平 2 负（**96.0%**） | 极速并排连泡截杀，失误源于死角自陷与一血险负 |
| **高级时空 A*** | 多步引信推演、时空 A* 避险与包抄 | 78 胜 14 平 8 负（**92.0%**） | 90 胜 10 平 0 负（**100.0%**） | 空场景零封对手，全场景依靠推箱与连环泡破局 |
| **逃跑拉扯怪（Flee）** | 快速拉开距离、动态避弹风筝逃跑 | 71 胜 20 平 9 负（**91.4%**） | 65 胜 25 平 10 负（**90.0%**） | 彻底根除发呆，强行贴身四向合围截杀 |
| **规则 BFS 猎人** | 全局多源 Dijkstra 追击，高频落泡压制 | 69 胜 37 平 22 负（**82.8%**） | 83 胜 13 平 4 负（**96.0%**） | 复杂图利用掩体伏击，开阔地引线瞬燃反杀 |

> 注：不败率统计为「胜局 + 超时平局」。人类对战 50 局实测中 AI 战绩为 43 胜 5 平 2 负（胜率 86.0%，不败率 96.0%）。人类获胜的两局中，一局源于 AI 在死角窄道落泡自陷，另一局为一血极限残局险胜；5 局平局多为双方满速拉扯互未露出致命破绽。
