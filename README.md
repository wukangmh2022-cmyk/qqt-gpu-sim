...
| 训练量口径 | **实际现役最新快照 `params_it00000831_ema`**：**831 iter × 12.57M 步/iter = 10,433,617,920 步（约 10.43B 全局步 / 104.3 亿步）**<br>（阶段三 8h 完赛基线 `it1100_ema` 累计 13.83B 步；原 15500 iter ≈ 260B 为前期理论满配规划） |
