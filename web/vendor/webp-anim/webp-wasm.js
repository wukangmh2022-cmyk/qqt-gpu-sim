...
// 浏览器胶水：裸 <script> 标签下工厂函数被闭包困住（无 exports/define 分支），
// 这里把顶层 var Module（工厂）挂到 window 供 anim.global.js 使用。
if (typeof window !== 'undefined' && !window.WebPAnimModule) {
  window.WebPAnimModule = Module;
}
