...
(async () => {
  ...
  const mPhase2 = await loadModel("params_it00000064_ema");

  const rPhase2 = await runCheckpointEval(mPhase2, "Phase 2 it64 (30min 巡检)", mBase, m782);
  console.log("\n==============================================================================");
  console.log("🏆 第二阶段 30分钟大巡检快照 it64 核心五维攻防实测报表 (各20局实测)");
  console.log("==============================================================================");
  console.log(JSON.stringify(rPhase2, null, 2));
})();
