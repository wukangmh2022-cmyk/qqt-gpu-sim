...
(async () => {
  ...
  const mBreakthrough191 = await loadModel("params_it00000191_ema");

  const rBreakthrough191 = await runCheckpointEval(mBreakthrough191, "Breakthrough it191 (1h30m 进阶版)", mBase, m782);
  console.log("\n==============================================================================");
  console.log("🏆 破局新训 1小时30分快照 it191 核心五维攻防实测报表 (各20局全量实测)");
  console.log("==============================================================================");
  console.log(JSON.stringify(rBreakthrough191, null, 2));
})();
