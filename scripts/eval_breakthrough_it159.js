...
(async () => {
  ...
  const mBreakthrough159 = await loadModel("params_it00000159_ema");

  const rBreakthrough159 = await runCheckpointEval(mBreakthrough159, "Breakthrough it159 (1h15m 进阶版)", mBase, m782);
  console.log("\n==============================================================================");
  console.log("🏆 破局新训 1小时15分快照 it159 核心五维攻防实测报表 (各20局全量实测)");
  console.log("==============================================================================");
  console.log(JSON.stringify(rBreakthrough159, null, 2));
})();
