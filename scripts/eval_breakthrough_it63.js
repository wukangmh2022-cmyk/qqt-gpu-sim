...
(async () => {
  ...
  const mBreakthrough63 = await loadModel("params_it00000063_ema");

  const rBreakthrough63 = await runCheckpointEval(mBreakthrough63, "Breakthrough it63 (30min 破局版)", mBase, m782);
  console.log("\n==============================================================================");
  console.log("🏆 破局新训 30分钟里程碑快照 it63 核心五维攻防实测报表 (各20局全量实测)");
  console.log("==============================================================================");
  console.log(JSON.stringify(rBreakthrough63, null, 2));
})();
