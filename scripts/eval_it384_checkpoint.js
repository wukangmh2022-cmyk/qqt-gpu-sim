...
(async () => {
  ...
  const m384  = await loadModel("params_it00000384_ema");

  const r384 = await runCheckpointEval(m384, "it384 (3h10m 最新)", mBase, m782);
  console.log("\n==============================================================================");
  console.log("🏆 15:30 巡检最新快照 it384 核心五维攻防对照报表 (各20局实测)");
  console.log("==============================================================================");
