...
(async () => {
  ...
  const m384  = await loadModel("params_it00000512_ema");

  const r384 = await runCheckpointEval(m384, "it512 (4h10m 最新)", mBase, m782);
  console.log("\n==============================================================================");
  console.log("🏆 16:30 巡检最新快照 it512 核心五维攻防对照报表 (各20局实测)");
  console.log("==============================================================================");
  console.log(JSON.stringify(r384, null, 2));
})();
