...
(async () => {
  ...
  const mBreakthrough = await loadModel("params_it00000031_ema");

  const rBreakthrough = await runCheckpointEval(mBreakthrough, "Breakthrough it31 (15min 破局版)", mBase, m782);
  console.log("\n==============================================================================");
  console.log("🏆 破局新训 15分钟首发快照 it31 核心五维攻防实测报表 (各20局全量实测)");
  console.log("==============================================================================");
  console.log(JSON.stringify(rBreakthrough, null, 2));
})();
