...
(async () => {
  ...
  const m384  = await loadModel("params_it00000448_ema");

  const r384 = await runCheckpointEval(m384, "it448 (3h40m 最新)", mBase, m782);
  console.log("\n==============================================================================");
  console.log("🏆 16:00 巡检最新快照 it448 核心五维攻防对照报表 (各20局实测)");
  console.log("==============================================================================");
