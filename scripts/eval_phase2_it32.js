...
(async () => {
  ...
  const mPhase2 = await loadModel("params_it00000032_ema");

  const rPhase2 = await runCheckpointEval(mPhase2, "Phase 2 it32 (15min 探针)", mBase, m782);
  console.log("\n==============================================================================");
  console.log("🏆 第二阶段 15分钟首发快照 it32 核心五维攻防实测报表 (各20局实测)");
  console.log("==============================================================================");
