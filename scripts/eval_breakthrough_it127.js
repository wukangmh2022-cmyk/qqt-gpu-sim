...
(async () => {
  ...
  const mBreakthrough127 = await loadModel("params_it00000127_ema");

  const rBreakthrough127 = await runCheckpointEval(mBreakthrough127, "Breakthrough it127 (1h 里程碑版)", mBase, m782);
  console.log("\n==============================================================================");
  console.log("🏆 破局新训 1小时里程碑快照 it127 核心五维攻防实测报表 (各20局全量实测)");
  console.log("==============================================================================");
  console.log(JSON.stringify(rBreakthrough127, null, 2));
})();
