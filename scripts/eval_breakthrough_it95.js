...
(async () => {
  ...
  const mBreakthrough95 = await loadModel("params_it00000095_ema");

  const rBreakthrough95 = await runCheckpointEval(mBreakthrough95, "Breakthrough it95 (45min 破局版)", mBase, m782);
  console.log("\n==============================================================================");
  console.log("🏆 破局新训 45分钟关键快照 it95 核心五维攻防实测报表 (各20局全量实测)");
  console.log("==============================================================================");
  console.log(JSON.stringify(rBreakthrough95, null, 2));
})();
